    ...
    <div class="container mt-5" >
        <div class="row">
            ...
            <div class="col-md-4" style="margin: auto;">
                ...
                <form action="platilloInsertar.php" method="POST">
                    ...
                    <p class="text"> Marca</p><input type="text" class="form-control mb-3" name="proveedor" placeholder="Marca">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="text4">
                                ...
                                <th><a href="platilloActualizar.php?id=<?php echo $row['codigo'] ?>" class="btn btn-info">Editar</a></th>
                                <th><a href="platilloEliminar.php?id=<?php echo $row['codigo'] ?>" class="btn btn-danger">Eliminar</a></th>
                            </tr>
                        <?php
                        }
                        ?>
